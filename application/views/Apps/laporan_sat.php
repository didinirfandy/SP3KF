...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-file-text"></i> Laporan Satpam</h1>
                <p>MENGATASI MASALAH TANPA MASALAH!!!</p>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item"><a href="#"> Laporan Satpam</a></li>
            </ul>
        </div>
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="tile-title-w-btn">
                            <?php
                                ...
                                {
                                    foreach ($nilai_sat_fix as $n) { } 
                                        if (isset($n['periode'])) { ?>
                                    <h4 class="title">Laporan Nilai Satpam Bulan
                                        <?php
                                ...
                                <h4 class="title">Laporan Nilai Satpam</h4>
                                <?php }?>
                        ...
                        <div class="row">
                            <div class="form-group mx-sm-3 mb-2">
                                <?= form_open('Home/cari_bulan_laporan_sat'); ?>
                        ...
                        <table class="table table-hover table-bordered table-sm" id="sampleTable">
                            ...
                            <tbody>
                                ...
                                {
                                    $i=1;
                                    foreach ($nilai_sat_fix as $nf ) 
                                    { ?>
                                    <tr>
                                        <td><?= $i++; ?></td>
                                        <td><?= $nf['nama_satpam'] ?></td>
                                        <td><?= $nf['nik'] ?></td>
                                        <td><?= $nf['unit_kerja'] ?></td>
                                        <td><?= $nf['no_hp'] ?></td>
