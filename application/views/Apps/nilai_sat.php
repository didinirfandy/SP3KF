...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-file-text"></i> Hasil Penilaian Satpam</h1>
                ...
                <div class="tile">
                    <div class="card-body">
                        <div class="tile-title-w-btn">
                            <h4 class="title">Rangking Satpam</h4>
                        </div>
                        <hr align="right" color="black">
                        <div class="row">
                            <div class="form-group mx-sm-3 mb-2">
                                <?= form_open('Home/c_nilai_sat'); ?>
                                ...
                                if(isset($_POST['bulan']))
                                    {
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?= base_url()?>Home/grafik_sat/<?= $nf['nik'] ?>" class="btn btn-info "><i class="fa fa-area-chart"></i>Lihat Grafik </a>
                                            </td>
                                        </tr>
                                    <?php }  ?>
                                <?php } else { ?>
