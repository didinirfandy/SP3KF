...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-pencil-square-o"></i> Grafik Penilaian Karyawan Oprasional</h1>
            ...
            <div class="col-md-6">
                <div class="row user1">
                    ...
                    <div class="col-md-5">
                        <div class="profile1">
                            <div class="info">
                                <img class="app-sidebar__user-avatar1" src="<?= base_url(); ?>assets_application/assets/faces/<?= $nilai_fix_kar['image']; ?>">
                                <h4><?php $str = $nilai_fix_kar['nama_karyawan'];
                                    echo wordwrap($str, 15, "<br>\n"); ?>
                                </h4>
                                <p>Karyawan Oprasional</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <script type="text/javascript">
        var data = {
            labels: ["Pakaian", "Perilaku / Sikap", "Penerimaan Telepon"],
            datasets: [
                {
                    ...
                    data: [<?= $nilai_fix_kar['pakaian'] ?>, <?= $nilai_fix_kar['perilaku'] ?>, <?= $nilai_fix_kar['telepon'] ?>]
                }
            ]
        }
