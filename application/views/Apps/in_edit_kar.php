...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-bar-chart"></i> Edit Penilaian Karyawan Oprasional</h1>
            ...
            <ul class="app-breadcrumb breadcrumb">
                ...
                <li class="breadcrumb-item">Edit Nilai Karyawan</li>
            </ul>
        </div>
                ...
                <div class="tile">
					<div class="card-body">
						...
						<div class="modal-footer">
                            <a class="btn btn-secondary" href="<?= Base_url();?>Home/edit_nilai_kar"><i class="fa fa-arrow-left"></i>Kembali</a>
