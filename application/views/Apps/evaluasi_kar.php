...
<body class="app sidebar-mini rtl">
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="fa fa-bar-chart"></i> Evaluasi Karyawan</h1>
                <p>MENGATASI MASALAH TANPA MASALAH!!!</p>
            </div>
            <ul class="app-breadcrumb breadcrumb">
                <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
                <li class="breadcrumb-item"><a href="#">Evaluasi Karyawan</a></li>
            </ul>
        </div>
        <?php 
        foreach ($evaluasi_kar as $e ) {?>
        <div class="row">
            <div class="col-md-12">
                <div class="tile">
                    <div class="tile-title-w-btn">
                        ...
                        <div class="btn-group">
                            <a class="btn btn-primary" href="<?= Base_url();?>Home/evaluasi_nilai_kar/<?= date('Y-m-d', strtotime($e['periode'])) ?>"><i class="fa fa-eye"></i>Lihat Nilai</a>
                        </div>
                    </div>
                    <table>
                        <tbody>
